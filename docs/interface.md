...
| `/subscribe "ЦСКА"` | If the team has an active mock paid period: `✅ Вы подписались на "ЦСКА"!` and the venue is added automatically. Otherwise the bot explains that every team requires a 39 RUB/month or 390 RUB/year mock subscription on the website; no real money is charged. |
