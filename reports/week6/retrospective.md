...
- **ADRs were written retroactively.** By the time ADR-001 was created, the parser architecture was already implemented. Retroactive ADRs are less precise and miss the context of the original trade-off discussion.
