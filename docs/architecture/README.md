...
- **Health monitoring** — The web service has a `/stats` health check; the worker has no equivalent. An external uptime monitor or a Telegram heartbeat message to the admin chat should be considered to detect worker stalls. |
