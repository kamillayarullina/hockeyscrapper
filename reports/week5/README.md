...
| PBI | Issue | SP | Status |
|---|---|---|---|
| Admin Panel | [#131](https://github.com/kamillayarullina/hockeyscrapper/issues/131) | 5 | Done |
| Interface improving | [#179](https://github.com/kamillayarullina/hockeyscrapper/issues/179) | 1 | Done |
| Email notification | [#182](https://github.com/kamillayarullina/hockeyscrapper/issues/182) | 3 | Done |
| Quality-requirements tests (QR-004, QR-005) | [#186](https://github.com/kamillayarullina/hockeyscrapper/issues/186) | 1 | Done |
| Implement a backend for uploading avatars | [#191](https://github.com/kamillayarullina/hockeyscrapper/issues/191) | 2 | Done |
| Improve the design of register and login pages | [#199](https://github.com/kamillayarullina/hockeyscrapper/issues/199) | 2 | Done |

### Delivered MVP v2 Changes

| Change | Issue/PR | Summary |
|---|---|---|
| Admin panel | [#131](https://github.com/kamillayarullina/hockeyscrapper/issues/131), PR [#187](https://github.com/kamillayarullina/hockeyscrapper/pull/187) | API endpoints for managing parsing interval, proxies, users, and system settings |
| Interface improvement |  [#199](https://github.com/kamillayarullina/hockeyscrapper/issues/199), [#179](https://github.com/kamillayarullina/hockeyscrapper/issues/179), PR [#181](https://github.com/kamillayarullina/hockeyscrapper/pull/181), [200](https://github.com/kamillayarullina/hockeyscrapper/pull/200)| Improved UI/UX across main pages — better layout, responsive design, consistent styling |
| Email notifications (US-05) | [#182](https://github.com/kamillayarullina/hockeyscrapper/issues/182), PR [#194](https://github.com/kamillayarullina/hockeyscrapper/pull/194) | SMTP-based email alerts sent to users when ticket availability changes for subscribed teams |
| New quality requirements | [#186](https://github.com/kamillayarullina/hockeyscrapper/issues/186), PR [#178](https://github.com/kamillayarullina/hockeyscrapper/pull/178) | QR-004 (ruff lint compliance) and QR-005 (startup reliability) with corresponding QRTs |
| Uploading avatars to DB | [#191](https://github.com/kamillayarullina/hockeyscrapper/issues/191), PR [203](https://github.com/kamillayarullina/hockeyscrapper/pull/203) | User uploaded images for profile page are stored in the DB |
### Deployment
...
- **Monetisation (US-06)**: The team scoped a plan but ran out of capacity to begin implementation. It remains a MoSCoW "Must have" with no committed sprint. The next sprint (Sprint 4) should include this work.
...
Rendered SVG output is available in each view in [`docs/architecture`](../../docs/architecture).
...
| Unit | `tests/test_notifier.py` | 3 | Notification dispatch, deduplication, message formatting |
| Integration | `tests/test_api_integration.py` | 16 | Register, login, forgot/new password, /me, /stats |
| Integration | `tests/test_parser_runner.py` | 1 | Parser runner new match detection and notification |
| QRT | `tests/test_fault_tolerance.py` | 1 | QR-01 parser retry isolation on network failure |
| QRT | `tests/test_auth_confidentiality.py` | 1 | QR-02 unauthorized access rejection |
| QRT | `tests/test_notification_performance.py` | 1 | QR-03 notification matching speed under load |
...
`https://drive.google.com/file/d/1Ym7h2C28IpDeRJeXNAEucwWeAH-iRlVY/view?usp=sharing`
...
**Quality infrastructure:** 78 automated tests, ruff lint gate, bandit security gate, pip-audit dependency scan, coverage gate (fail_under >= 20%), lychee link check, branch protection with required reviews, 5 quality requirements linked to architecture decisions.
...
2. **Ensure compatability with mobile** — Make sure that website runs normally on mobile.
3. **Parser functionality update** — Make parser work with individual KHL sites.
...
|---|---|---|---|---|---|---|
| Kamilla Iarullina | [kamillayarullina](https://github.com/kamillayarullina) | [issues](https://github.com/kamillayarullina/hockeyscrapper/issues?q=is%3Aissue+author%3Akamillayarullina) | [PRs](https://github.com/kamillayarullina/hockeyscrapper/issues?q=is%3Apr+author%3Akamillayarullina) | [reviews](https://github.com/kamillayarullina/hockeyscrapper/issues?q=is%3Apr+reviewed-by%3Akamillayarullina) | - | deployment-process, UAT, ropadmap, llm-report, documentation site |
| Gleb Shamiev | [xleb-sha](https://github.com/xleb-sha) | [issues](https://github.com/kamillayarullina/hockeyscrapper/issues?q=is%3Aissue+author%3Axleb-sha) | [PRs](https://github.com/kamillayarullina/hockeyscrapper/issues?q=is%3Apr+author%3Axleb-sha) | [reviews](https://github.com/kamillayarullina/hockeyscrapper/issues?q=is%3Apr+reviewed-by%3Axleb-sha) | QR-004, QR-005 | Deployment, static, dynamic diagrams, QR tests documentation |
| Samir Shakirov | [samirshakirov6](https://github.com/samirshakirov6) | [issues](https://github.com/kamillayarullina/hockeyscrapper/issues?q=is%3Aissue+author%3Asamirshakirov6) | [PRs](https://github.com/kamillayarullina/hockeyscrapper/issues?q=is%3Apr+author%3Asamirshakirov6) | [reviews](https://github.com/kamillayarullina/hockeyscrapper/issues?q=is%3Apr+reviewed-by%3Asamirshakirov6) | - | defenition0of-done, reflection, retrospective, adr |
...
![Sprint Backlog Board](images/board1.png)
![Sprint Backlog Board](images/board2.png)
![Sprint Backlog Board](images/board3.png)
...
![Reviewed PR](images/pr.png)

### Hosted Docs Site

![Hosted Docs Site](images/doc_site.png)
